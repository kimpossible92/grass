...
public class ToolsChC : MonoBehaviour
{
    PlayerC character;
    Rigidbody2D rgbd2d;
    [SerializeField] MarkerM markerManager;
    [SerializeField] TileMapReadC tileMapReadController;
    [SerializeField] CropsReadC cropsReadController;
    [SerializeField] float maxDistance = 2f;
    [SerializeField] CropsM cropsManager;
    ...
    void Start()
    {
        character = GetComponent<PlayerC>();
        ...
        inventoryController = GetComponent<InventoryC>();

        var shopPanelAll = Resources.FindObjectsOfTypeAll<UIShopC>();
    ...
    private void UseTool()
    {
        ...
        if (selectable == true && toolbarController.GetItem != null)
        {
            ...
            /*if (toolbarController.GetItem.Name == "WateringCan" && fields[(Vector2Int)selectedTilePosition].watered) //if you are using watering can - play sound of water
                FindObjectOfType<SoundMM>().Play("Water");*/
                ...
                else if (fields[(Vector2Int)selectedTilePosition].ableToSeed && toolbarController.GetItem.isSeed == true)
                {
                    switch (toolbarController.GetItem.Name) //depending on what seed you have chosen
                    {
                        case "Seeds_Corn":
                            ...
                            if (GameM.instance.inventoryContainer.slots[toolbarController.selectedTool].count 
                                >= cornSeedsCount)
                            {
                                cropsManager.SeedCrop(selectedTilePosition, "corn");
                                GameM.instance.inventoryContainer.RemoveItem(toolbarController.GetItem, cornSeedsCount);   // Deletes 4 seeds
                            }
                        break;
                        case "Seeds_Parsley":
                                ...
                                >= parsleySeedsCount)
                            {
                                ...
                                GameM.instance.inventoryContainer.RemoveItem(toolbarController.GetItem, parsleySeedsCount);  // Deletes 3 seeds
                            }
                        break;
                        case "Seeds_Potato":
                                ...
                                >= potatoSeedsCount)
                            {
                                ...
                                GameM.instance.inventoryContainer.RemoveItem(toolbarController.GetItem, potatoSeedsCount);   // Deletes 1 seed
                            }
                        break;
                        case "Seeds_Strawberry":
                                ...
                                >= strawberrySeedsCount)
                            {
                                ...
                                GameM.instance.inventoryContainer.RemoveItem(toolbarController.GetItem, strawberrySeedsCount); // Deletes 6 seeds
                            }
                        break;
                        case "Seeds_Tomato":
                            // Checking whether we have more than 3 seeds to seed
                                ...
                                >= tomatoSeedsCount)
                            {
                                ...
                                GameM.instance.inventoryContainer.RemoveItem(toolbarController.GetItem, tomatoSeedsCount);   // Deletes 3 seeds
                            }
                        break;
                    }
            ...
            else if (crops[(Vector2Int)selectedTilePosition].collectibleCorn && toolbarController.GetItem.Name == "Bag")
            {
                ...
                foreach (ItemSlot itemSlot in GameM.instance.allItemsContainer.slots)
                {
                    if (itemSlot.item.Name == "Food_Corn")
                    {
                        GameM.instance.inventoryContainer.Add(itemSlot.item, cornPickUpCount);
                        RefreshToolbar();
                        break;
                    }
                }
            ...
            else if (crops[(Vector2Int)selectedTilePosition].collectibleParsley && toolbarController.GetItem.Name == "Bag")
            {
                ...
                foreach (ItemSlot itemSlot in GameM.instance.allItemsContainer.slots)
                {
                    ...
                    {
                        GameM.instance.inventoryContainer.Add(itemSlot.item, parsleyPickUpCount);
                        RefreshToolbar();
                        break;
                    }
                }
            ...
            else if (crops[(Vector2Int)selectedTilePosition].collectiblePotato && toolbarController.GetItem.Name == "Bag")
            {
                ...
                foreach (ItemSlot itemSlot in GameM.instance.allItemsContainer.slots)
                {
                    ...
                    {
                        GameM.instance.inventoryContainer.Add(itemSlot.item, potatoPickUpCount);
                        RefreshToolbar();
                        break;
                    }
                }
            ...
            else if (crops[(Vector2Int)selectedTilePosition].collectibleStrawberry && toolbarController.GetItem.Name == "Bag")
            {
                ...
                foreach (ItemSlot itemSlot in GameM.instance.allItemsContainer.slots)
                {
                    ...
                    {
                        GameM.instance.inventoryContainer.Add(itemSlot.item, strawberryPickUpCount);
                        RefreshToolbar();
                        break;
                    }
                }
            ...
            else if (crops[(Vector2Int)selectedTilePosition].collectibleTomato && toolbarController.GetItem.Name == "Bag")
            {
                ...
                foreach (ItemSlot itemSlot in GameM.instance.allItemsContainer.slots)
                {
                    ...
                    {
                        GameM.instance.inventoryContainer.Add(itemSlot.item, tomatoPickUpCount);
                        RefreshToolbar();
                        break;
                    }
                }
